    ...
    <>
      <div className='container col-11 col-sm-10 col-mg-9 col-lg-8'>
        ...
        <DivWrite className="d-flex justify-content-between">
          ...
          <ToggleButtonGroup type="radio" name="options" defaultValue={4} className='mb-4'>
            <ToggleButton id="tbg-radio-1" value={1} variant="" className="ms-2 me-2 rounded">기술</ToggleButton>
            <ToggleButton id="tbg-radio-2" value={2} variant="" className="ms-2 me-2 rounded">커리어</ToggleButton>
            <ToggleButton id="tbg-radio-3" value={3} variant="" className="ms-2 me-2 rounded">기타</ToggleButton>
            <ToggleButton id="tbg-radio-4" value={4} variant="" className="ms-2 me-2 rounded">전체</ToggleButton>
          </ToggleButtonGroup>
